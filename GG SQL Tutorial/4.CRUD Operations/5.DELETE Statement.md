A instrução **SQL DELETE** é um dos comandos mais utilizados no **SQL (Structured Query Language)**. Ele permite **remover uma ou mais linhas** de uma tabela, conforme necessário.
